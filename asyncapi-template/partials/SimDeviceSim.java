...
public class SimDeviceSim extends StateDevice<SimDeviceSim.State> {
    ...
    /**
     * Registers a SimDeviceCallback to be called whenever a new SimDeviceSim is created with a given prefix. A SimDeviceSim is determined to be created if a value on it has been set.
