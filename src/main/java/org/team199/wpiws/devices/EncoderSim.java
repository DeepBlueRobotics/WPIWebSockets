...
public class EncoderSim extends StateDevice<EncoderSim.State> {
    ...
    public static class State {
        ...
        public final CopyOnWriteArrayList<IntegerCallback> CHANNELA_CALLBACKS = new CopyOnWriteArrayList<>();
        
        
        public final CopyOnWriteArrayList<IntegerCallback> CHANNELB_CALLBACKS = new CopyOnWriteArrayList<>();
