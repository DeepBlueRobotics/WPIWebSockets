...
public class PWMSim extends StateDevice<PWMSim.State> {
    ...
    public static class State {
        ...
        public final CopyOnWriteArrayList<DoubleCallback> SPEED_CALLBACKS = new CopyOnWriteArrayList<>();public final CopyOnWriteArrayList<DoubleCallback> POSITION_CALLBACKS = new CopyOnWriteArrayList<>();public final CopyOnWriteArrayList<IntegerCallback> RAW_CALLBACKS = new CopyOnWriteArrayList<>();public final CopyOnWriteArrayList<DoubleCallback> PERIODSCALE_CALLBACKS = new CopyOnWriteArrayList<>();public final CopyOnWriteArrayList<BooleanCallback> ZEROLATCH_CALLBACKS = new CopyOnWriteArrayList<>();
    }
